...
import { View, Text, StyleSheet, FlatList, SafeAreaView, ScrollView, StatusBar, TouchableOpacity, Image, Alert } from 'react-native';
...
export default function EserciziLiv2() {
	...
	<SafeAreaView style={styles.container}>
		...
		<ScrollView style={styles.scrollView}>     
			...
			<View style={styles.livello}>
				...
				<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'CAMMINO' }}) }>		
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'RINFORZO QUADRICIPITE' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'RINFORZO MUSCOLI' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5}}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'RINFORZO GLUTEI' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'POSA 1' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'POSA 2' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:2, blocco:'POSA 3' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
