...
export default function EserciziLiv4() {
		...
		<ScrollView style={styles.scrollView}>     
			...
			<View>
				<Text style={styles.sottotitoloText}>
					60 minuti 3 volte a settimana, più 20 minuti camminata veloce per 2 volte a settimana 
				</Text>
			</View>
			...
			<View style={styles.livello}>
				...
				<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'JOGGING' }}) }>		
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'RINFORZO QUADRICIPITE' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'RINFORZO MUSCOLI' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5}}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'RINFORZO GLUTEI' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'SQUAT' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'AFFONDI' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'SIT-UPS' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'POSA 1' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'POSA 2' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
			...
			<TouchableOpacity onPress={() => router.push( { pathname: '/ilTuoAllenamento/', params: { id:4, blocco:'POSA 3' }}) }>		
			<Card style={styles.item}>
				<View style={{ flexDirection: 'row', marginHorizontal: 5 }}>		
					<View style={{ flex: 1 }}>
